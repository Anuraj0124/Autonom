  ...
  render() {
    ...
    return (
     ...
     initial as well as subsequent assessment."
            ...
            <Select
              ...
              defaultValue={values.pulmonaryScore}
              fullWidth
            >
    ...
    oxygen gas dissolved in the blood. </option>
            ...
            <Select
              ...
              defaultValue={values.cardiologicalPressure}
              fullWidth
            >
    ...
    a patient's arteries during one cardiac cycle.</option>
            ...
            <TextField
              ...
              type="number" inputProps={{ min: 0}}
              defaultValue={values.hdlCholesterol}
              margin="normal"
              fullWidth
            />
            <br />
            <TextField
              ...
              defaultValue={values.charlsonIndex}
            ...
            <TextField
              ...
              type="number" inputProps={{ min: 0}}
              defaultValue={values.bloodGlucose}
              margin="normal"
              fullWidth
            />
            <TextField
